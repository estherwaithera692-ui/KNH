                    ...
                    <form method="POST" action="{{ route('admin.residents.store') }}">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="identification_number" name="identification_number" type="text" class="mt-1 block w-full" :value="old('identification_number')" required />
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="address" name="address" rows="3" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>{{ old('address') }}</textarea>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="resident_number" name="resident_number" type="text" class="mt-1 block w-full" :value="old('resident_number')" required />
                                    <x-input-error :messages="$errors->get('resident_number')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="resident_area" :value="__('Resident Area')" />
                                    <x-text-input id="resident_area" name="resident_area" type="text" class="mt-1 block w-full" :value="old('resident_area')" placeholder="e.g., University, Hospital" required />
                                    <x-input-error :messages="$errors->get('resident_area')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="role" :value="__('Role')" />
                                    <x-text-input id="role" name="role" type="text" class="mt-1 block w-full" :value="old('role')" placeholder="e.g., Doctor, Nurse, Student" required />
                                    <x-input-error :messages="$errors->get('role')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="department" :value="__('Department')" />
                                    <x-text-input id="department" name="department" type="text" class="mt-1 block w-full" :value="old('department')" placeholder="e.g., Surgery, Pediatrics" required />
                        ...
                        <div class="mb-8">
                            ...
                            <div>
                                ...
                                <textarea id="medical_credentials" name="medical_credentials" rows="4" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Enter medical qualifications, certifications, etc.">{{ old('medical_credentials') }}</textarea>
                        ...
                        <div class="flex items-center justify-end">
                            <a href="{{ route('admin.residents.index') }}" class="mr-4 text-gray-600 hover:text-gray-900">Cancel</a>
                            <x-primary-button>
                                {{ __('Create Resident') }}
                            </x-primary-button>
                        </div>
