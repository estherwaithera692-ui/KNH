...
<body class="bg-gray-100">
    ...
    <div class="main-content">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">Edit Employee</h1>
            <p class="text-gray-600">Update information for {{ $employee->first_name }} {{ $employee->last_name }}</p>
        </div>
        ...
        <div class="form-container">
            <form method="POST" action="{{ route('admin.employees.update', $employee) }}" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $employee->date_of_birth->format('Y-m-d')) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            @error('date_of_birth')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="tel" id="contact_number" name="contact_number" value="{{ old('contact_number', $employee->contact_number) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="address" name="address" rows="3" required
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('address', $employee->address) }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="qualification" name="qualification" value="{{ old('qualification', $employee->qualification) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            @error('qualification')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" id="years_of_experience" name="years_of_experience" value="{{ old('years_of_experience', $employee->years_of_experience) }}" min="0" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="date" id="date_joined" name="date_joined" value="{{ old('date_joined', $employee->date_joined->format('Y-m-d')) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            @error('date_joined')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select id="role" name="role" required
                                ...
                                <option value="Pharmacist" {{ old('role', $employee->role) == 'Pharmacist' ? 'selected' : '' }}>Pharmacist</option>
                                <option value="Lab Tech" {{ old('role', $employee->role) == 'Lab Tech' ? 'selected' : '' }}>Lab Tech</option>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="license_number" name="license_number" value="{{ old('license_number', $employee->license_number) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="date" id="license_expiry_date" name="license_expiry_date" value="{{ old('license_expiry_date', $employee->license_expiry_date->format('Y-m-d')) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="file" id="certificate" name="certificate" accept=".pdf,.jpg,.jpeg,.png"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <p class="mt-1 text-sm text-gray-500">Accepted formats: PDF, JPG, JPEG, PNG. Max size: 2MB. Leave empty to keep current certificate.</p>
                            @if($employee->certificate_path)
                                <p class="mt-2 text-sm text-green-600">
                                    <i class="fas fa-check-circle mr-1"></i>Current certificate: <a href="{{ asset('storage/' . $employee->certificate_path) }}" target="_blank" class="underline">View Certificate</a>
                                </p>
                            @endif
                            @error('certificate')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="emergency_contact_name" name="emergency_contact_name" value="{{ old('emergency_contact_name', $employee->emergency_contact_name) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="text" id="emergency_contact_relationship" name="emergency_contact_relationship" value="{{ old('emergency_contact_relationship', $employee->emergency_contact_relationship) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="tel" id="emergency_contact_phone" name="emergency_contact_phone" value="{{ old('emergency_contact_phone', $employee->emergency_contact_phone) }}" required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="flex justify-end space-x-4">
                    <a href="{{ route('admin.employees.show', $employee) }}" class="btn-secondary">Cancel</a>
